...
//Customer Reviews
app.controller("reviewData",function ($scope){
    class review{
    ...
    $scope.reviews = [
        new review("Bella Stones","images/clients/customer.jpg",1,"\n" +
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
            "Cras cursus augue id quam rhoncus tincidunt. Duis mauris odio. Duis mauris odio, vestibulum ac maximus a, blandit sed ex."),
        ...
        new review("Jack Samuel",'images/clients/customer5.jpg',2,"\n" +
            ...
            "Nullam sed bibendum turpis. Maecenas in lobortis sapien."),
        ...
        new review("John Doe",'images/clients/customer1.jpg',4,"\n" +
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
            "Nullam sed bibendum turpis. Maecenas in lobortis sapien. Nulla sed magna feugiat, malesuada lectus nec, laoreet elit. " +
            "Phaselluse eu dictum lorem ultrices."),

        new review("John Doe",'images/clients/customer2.jpg',5,"\n" +
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
            "Nullam sed bibendum turpis. Maecenas in lobortis sapien. Nulla sed magna feugiat, malesuada lectus nec, laoreet elit."),

        new review("Ben Graham",'images/clients/customer4.jpg',6,"\n" +
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
            "Nullam sed bibendum turpis. Maecenas in lobortis sapien. Nulla sed magna feugiat, malesuada lectus nec, laoreet elit. "),

        new review("Alex Solomon",'images/clients/customer6.jpg',7,"\n" +
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
            "Nullam sed bibendum turpis. Maecenas in lobortis sapien. Nulla sed magna feugiat, malesuada lectus nec, laoreet elit. ")
    ...
    $scope.swipeLeft = function (){
        if(window.innerWidth > 1200){
            document.querySelector(".all-reviews").scrollLeft += -300;
        } else if(window.innerWidth < 1200 && window.innerWidth > 640){
            document.querySelector(".all-reviews").scrollLeft += -500;
...
app.controller("promoController", function ($scope){
    class promotion{
        constructor(img, code, content, dueTime, details) {
            this.img = img;
            this.code = code;
    ...
    $scope.promotions = [
        new promotion('images/banner&offer/promotion1.png','SALEOFF30','Sale off 30% total bill.','Today','Available for every with bill > $60.00.'),
        new promotion('images/banner&offer/promotion2.png','-----','Sale off 50% for "Pizza of the Day" ','This Month','Sale off 50% for "Pizza of the Day." '),
        new promotion('images/banner&offer/promotion3.png','1PRICE2PIZZA-M','2 Pizzas size M for price of 1. ','Next Week','...'),
        new promotion('images/banner&offer/promotion4.png','FIRSTACC10','Discount $10.00 for joining our membership','Today','Available 1 time only for Casanova Member with bill > $30.00. Sign Up NOW!!')
    ]
...
app.controller("menuController", function ($scope, $rootScope){
    ...
    $scope.listOfFood = [
        ...
        new food("Sicilian","Pizza",5.00, 8.50, 13.50,null, null,"./images/menu/pizzas/sicilian.jpg",
...
app.controller("cartController",function($scope,$rootScope){
    ...
    $scope.discountCondition = null;

    function clearAlertForCoupon(){
        document.getElementById('code-failed').innerHTML = "";
    }
    document.getElementById('coupon').addEventListener("focus",()=>{
        clearAlertForCoupon()
    })
    ...
    $scope.applyCoupon = function (string) {
        ...
        switch (string) {
            case "FIRSTACC10":
                ...
                if(signIn_flag !== '1'){
                    $scope.discountCondition = false;
                    document.getElementById('code-failed').innerHTML = "Sign in to use this code!";
                }else if(signIn_flag === '1' && $rootScope.totalCartPrice < 30){
                    $scope.discountCondition = false;
                    document.getElementById('code-failed').innerHTML = "Total bill price must > $30.00 to use this code!";
                }else if(signIn_flag === '1' && $rootScope.totalCartPrice > 30){
                    $scope.discountCondition = true;
            ...
            case "SALEOFF30":
                $scope.discountFlag = true;
                if($rootScope.totalCartPrice < 60){
                    $scope.discountCondition = false;
                    document.getElementById('code-failed').innerHTML = "Total bill price must > $60.00 to use this code!";
                }else if($rootScope.totalCartPrice > 60){
                    $scope.discountCondition = true;
                    $rootScope.discount = $rootScope.totalCartPrice * 0.3;
                    clearAlertForCoupon();
                }
                break;
        }
